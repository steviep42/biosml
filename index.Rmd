...
The above is an example of what we would have to do if we didn't have something like caret to help us try out different values of **mtry** or other parameters. As we saw from our earlier work, the model **caret_rf** tried three different values of the **mtry** hyperparameter without us even asking for it. 
...
And then we can plot these results to get a more intuitive view of the output. 
